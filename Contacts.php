...
<html lang="en">
	...
	<body id="page5">
		<div class="main">
<!--header -->
			<header  style="background-color:#5c7575;">
				<div class="wrapper">
					<h1><a href="index3.php" id="logo">Superior.com</a></h1>
				...
				<nav>
					<ul id="menu">
						<li><a href="index3.php"><span>Homepage</span></a></li>
						<li><a href="Company.php"><span>Company</span></a></li>
						<li><a href="Solutions.php"><span>Solutions</span></a></li>
						<li><a href="Services.php"><span>Services</span></a></li>
						<li><a href="index.php"><span>Login</span></a></li>
						<li class="last active"><a href="Contacts.php"><span>Contacts</span></a></li>
					</ul>
				</nav>
			</header>
<!--header end-->
